			...
			"event": [
				{
					...
					"script": {
						"exec": [
							...
							"    pm.expect(Number(responseData.salary)).to.eql(Number(requestData.salary));\r",
							"});\r",
							"\r",
			...
			"event": [
				{
					...
					"script": {
						"exec": [
							...
							"\r",
							"pm.test(\"The response age\", function () {\r",
							"    pm.expect(Number(responseData.age)).to.eql(Number(requestData.age))\r",
							"});\r",
							"\r",
							...
							"    pm.expect(Number(responseData.salary[0])).to.eql(Number(requestData.salary));\r",
							"});\r",
							"\r",
			...
			"event": [
				{
					...
					"script": {
						"exec": [
							...
							"    pm.expect(Number(responseData.start_qa_salary)).to.eql(Number(requestData.salary))\r",
							"});\r",
							"\r",
							"// 15. Проверить, что параметр qa_salary_after_6_months равен salary*2 из request (salary забрать из request.)\r",
							"\r",
							"pm.test(\"salary*2 из request\", function () {\r",
							"    pm.expect(Number(responseData.qa_salary_after_6_months)).to.eql(Number(requestData.salary*2))\r",
							"});\r",
							"\r",
							"// 16. Проверить, что параметр qa_salary_after_12_months равен salary*2.7 из request (salary забрать из request.)\r",
							"\r",
							"pm.test(\"salary*2.7 из request\", function () {\r",
							"    pm.expect(Number(responseData.qa_salary_after_12_months)).to.eql(Number(requestData.salary*2.7))\r",
							"});\r",
							"\r",
							"// 17. Проверить, что параметр qa_salary_after_1.5_year равен salary*3.3 из request (salary забрать из request.)\r",
							"\r",
							"pm.test(\"salary*3.3 из request\", function () {\r",
							"    pm.expect(Number(responseData['qa_salary_after_1.5_year'])).to.eql(Number(requestData.salary*3.3))\r",
							"});\r",
							"\r",
							"// 18. Проверить, что параметр qa_salary_after_3.5_years равен salary*3.8 из request (salary забрать из request.)\r",
							"\r",
							"pm.test(\"salary*3.8 из request\", function () {\r",
							"    pm.expect(Number(responseData['qa_salary_after_3.5_years'])).to.eql(Number(requestData.salary*3.8))\r",
							"});\r",
							"\r",
							"// 19. Проверить, что в параметре person, 1-й элемент из u_name равен salary из request (salary забрать из request.)\r",
							"\r",
							"pm.test(\"The u_name[1]\", function(){\r",
							"    pm.expect(Number(responseData.person.u_name[1])).to.eql(Number(requestData.salary));\r",
							"});\r",
							"\r",
							"// 20. Проверить, что параметр u_age равен age из request (age забрать из request.)\r",
							"\r",
							"pm.test(\"age из request\", function () {\r",
							"    pm.expect(Number(responseData.person.u_age)).to.eql(Number(requestData.age))\r",
							"});\r",
							"\r",
							...
							"\r",
							"Object.keys(responseData.person).forEach(function(key) {\r",
